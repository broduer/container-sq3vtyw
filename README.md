...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-sq3vtyw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-sq3vtyw.containers.anotherwebservice.com/
...
```
git clone git@github.com:broduer/container-sq3vtyw.git
cd container-sq3vtyw
```
...
```
docker attach container-sq3vtyw
```
